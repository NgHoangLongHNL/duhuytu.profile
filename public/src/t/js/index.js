...
let typed=new Typed(".GioiThieu", {
  strings: ["","Huy Tu is an idiot =)))", "Huy Tu is ugly! "],
  typeSpeed: 95,
  backSpeed: 75,
  loop: true
})
...
function ShowToast() {
  ...
  $(document).ready(function() {
    ...
    $('#Facebook').click(function() {
        OpenUrl('https://www.facebook.com/share/18pZF5S1zF/?mibextid=wwXIfr');
    });
      // SET URL YOUTUBE
    $('#Youtube').click(function() {
        OpenUrl('https://t.me/anhtu_09');
    });
  });
...
function Alerts() {
  Swal.fire({
    title: '𝙉𝙤𝙩𝙞𝙛𝙞𝙘𝙖𝙩𝙞𝙤𝙣 !',
    text: '=>> Welcome to Huy Tu website but designed and coded by NgHoangLong 🐬 <<=',
